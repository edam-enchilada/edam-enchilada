 ...
 * License.
 *
 * The Original Code is EDAM Enchilada's ATOFMSReadSpec class.
 *
 ...
 */
public class ATOFMSReadSpec {
	private static final DateFormat dFormat = 
		new SimpleDateFormat("MM/dd/yyyy hh:mm:ss a");
	
	private  byte[] byteArray;
	private ByteBuffer byteBuff;
	private ATOFMSParticles particle;
	 ...
	 */
	public ATOFMSReadSpec(String file)  throws IOException, ZipException {
...
//		 Using the readFully method gets an EOFException.
	...
	public ATOFMSParticles createParticle(String name,
			String timetext,
			float laserpow,
			float digitrate,
			int scatdelay,
			...
			int[] negdata) {
		/*
		ATOFMSParticles p = new ATOFMSParticles(new File(name).getName(), timetext, laserpow, 
				digitrate, scatdelay, posdata, negdata);
		*/
		
		ATOFMSParticles p = new ATOFMSParticles(name, timetext, laserpow, 
				digitrate, scatdelay, posdata, negdata);
		return p;
	}
	...
	public ATOFMSParticles getParticle() {
		return particle;
	}
	
	public static void main(String[] args) throws IOException {
		ATOFMSParticles.currCalInfo = new ATOFMSCalInfo();
		ATOFMSParticles.currPeakParams = new ATOFMSPeakParams(30,30,0.01f);
		//ATOFMSReadSpec rs = new ATOFMSReadSpec
