 ...
 * License.
 *
 * The Original Code is EDAM Enchilada's ATOFMSCalInfo class.
 *
...
public class ATOFMSCalInfo {
	...
	/**
	 * Creates a ATOFMSCalInfo object from the given mass cal and size cal
	 * files.  
	 * 
	 * @param massCalFile
	 ...
	 */
	public ATOFMSCalInfo(String massCalFile, String sizeCalFile, boolean auto) 
	...
	/**
	 * Creates a ATOFMSCalInfo object from the given mass cal file and 
	 * ignores size.  
	 * 
	 * @param massCalFile
	 * The path to a size cal file. 
	 */
	public ATOFMSCalInfo(String massCalFile, boolean auto) 
		throws IOException, NumberFormatException
	{
		autocal = auto;
		sizecal = false;
