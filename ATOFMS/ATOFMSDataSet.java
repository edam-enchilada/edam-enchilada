...
public class ATOFMSDataSet {
	 ...
	 */ 
	private String name;
	private ATOFMSParticles[] particles;
	private ATOFMSPeakParams params;
	private ATOFMSCalInfo calInfo;
	 ...
	 */
	public ATOFMSDataSet (String n, ATOFMSParticles[] p, ATOFMSPeakParams pp, ATOFMSCalInfo c){
		name = n;
		particles = p;
		params = pp;
		calInfo = c;
	 ...
	 */
	public ATOFMSParticles[] getParticles(){
		return particles;
	}
	
	/**
	 * @return ATOFMSPeakParams object for dataset
	 */
	public ATOFMSPeakParams getParams(){
		return params;
	}
	
	/**
	 * @return ATOFMSCalInfo object for dataset
	 */
	public ATOFMSCalInfo getCalInfo(){
		return calInfo;
	}
