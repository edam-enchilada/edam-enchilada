 ...
 * 
 */
public abstract class CleanCopyofClusterK extends Cluster {
	 ...
	 * 
	 */
	public CleanCopyofClusterK(int cID, InfoWarehouse database, int k, 
	...
	public int divide() {
		...
		System.out.println("clustering particles: ");
