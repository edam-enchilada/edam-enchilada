...
public class Particle implements AtomicAnalysisUnit {
	...
	public ArrayList<Peak> getPeakList() {
		/* According to manual, baseline is defined as the average of the last 100
         data points in spectrum.  MS-Analyze has off-by-one error, so this won't match.*/
		//int posbaseline;
		//int negbaseline;
		//for (int i=27000;i<30000;i++) {
			//posbaseline = posSpectrum[]
			
		//}
        //posbaseline = floor(sum(posdata(27000:29999))/3000);
        //negbaseline = floor(sum(negdata(27000:29999))/3000);
