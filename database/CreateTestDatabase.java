...
public class CreateTestDatabase {
	...
	public void generateDynamicTables() {
		...
		Statement stmt = con.createStatement();
			stmt.executeUpdate(
			"INSERT INTO MetaData VALUES ('DataType2','[Time]','DATETIME',0,1)\n" +
			"INSERT INTO MetaData VALUES ('DataType2','[Number]','INT',0,2)\n" +
			"INSERT INTO MetaData VALUES ('DataType2','[Size]','REAL',1,1)\n" +
			"INSERT INTO MetaData VALUES ('DataType2','[Magnitude]','REAL',1,2)\n" +
			"INSERT INTO MetaData VALUES ('DataType2','P [Delay]','INT',2,1)\n" +
			"INSERT INTO MetaData VALUES ('DataType2','[Valid]','BIT',2,2)\n" +
			"CREATE TABLE DataType2DataSetInfo ([DataSetID] INT, [Time] DATETIME, [Number] INT,  PRIMARY KEY ([DataSetID]))\n" +
			"CREATE TABLE DataType2AtomInfoDense ([AtomID] INT, [Size] REAL, [Magnitude] REAL,  PRIMARY KEY ([AtomID]))\n" +
			"CREATE TABLE DataType2AtomInfoSparse ([AtomID] INT, [Delay] INT, [Valid] BIT, PRIMARY KEY ([AtomID], [Delay]))");
		} catch (SQLException e) {
