...
public class SPASSDataSetImporterTest extends TestCase {
	...
	protected void setUp() {
		try {
			...
			JOptionPane.showMessageDialog(null,
					...
					"  Close any other progrSPASS that may be accessing the database and try again.");
		}
	...
	private void testDataset(int items, int mzmin, int mzmax, int[] peaks, long tstart, long tdelta, 
		...
		double[] peakVals = {10, 20, 30, 40, 50};
		...
		try {
			...
			long curt = tstart-800;///- 3114199800l;
			Date currentDate;
			Date tempDate;
